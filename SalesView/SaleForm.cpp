...
System::Void SalesView::SaleForm::SaleForm_Load(System::Object^ sender, System::EventArgs^ e)
{
	txtDate->Text = DateTime::Now.ToString("dd/MM/yyyy");
	//this->Text = "Venta realizada por " + SalesMainForm::employee->Name + " " + SalesMainForm::employee->LastName;
}
...
System::Void SalesView::SaleForm::btnRegisterSale_Click(System::Object^ sender, System::EventArgs^ e)
{
	...
	sale->Id = 1; // Controller::QueryLastSaleId() + 1;
	sale->Customer = customer;
	sale->TxnDate = txtDate->Text;
	sale->Salesman = nullptr; //(Salesman^)SalesMainForm::employee;
